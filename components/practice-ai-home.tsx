      ...
      <div className='relative isolate overflow-hidden'>
        <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 bg-[#11131780] backdrop-blur-sm p-8 rounded-[24px] border border-[#21242C] shadow-lg'>
              <div className='text-center md:border-r-2 md:border-[#21242C]'>
                <p
                  style={{
                    background:
                      'linear-gradient(90deg, #81A348 0%, #ABCB38 100%);',
                  }}
                  className='text-5xl lg:text-[55px] font-bold text-[#81A348]'
                >
                  60%
                </p>
                <p className='text-[#9096A2] mt-2 text-[21px]'>
                  Revenue Increase
                </p>
              </div>
              <div className='text-center md:border-r-2 md:border-[#21242C]'>
                    ...
                    <div className='w-20 h-20 rounded-full flex items-center justify-center bg-[#0E3C23]'>
                      {benefit.image ? (
                        <img
                          src={benefit.image}
                          alt={benefit.label}
                          className='w-8 h-8 text-[#A0BE41]'
                        />
                      ) : Icon ? (
                        <Icon className='w-8 h-8 text-[#A0BE41]' />
                      ) : null}
                    </div>
                    <p className='text-[24px] md:text-[40px] font-bold text-[#526C42] mt-4'>
                      {benefit.value}
                    </p>
                    <p className='text-[#94A6B8] text-[14px] md:text-[16px] mt-1 text-balance'>
                      {benefit.label}
                    </p>
                  </div>
                );
          ...
          <section className='py-12'>
            <div className='text-center'>
              <p className='text-sm text-[#799B4B] border border-[#799B4B33] w-fit mx-auto px-3 py-2 rounded-full font-semibold tracking-wider'>
              ...
              <h2 className='text-4xl lg:text-5xl font-bold text-white mt-4 tracking-tight'>
                ...
                <span
                  style={{
                    background:
                      'linear-gradient(90deg, #779B48 0%, #9BB942 100%)',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
                  }}
                  className='text-transparent'
                >
                  Response to Curie AI
                </span>
              </h2>
              <p className='mt-4 text-lg text-gray-400 max-w-3xl mx-auto'>
                Real practitioners sharing their experience with AI-powered
            ...
            <div className='mt-16 max-w-4xl mx-auto'>
              ...
              <div
                style={{ boxShadow: ' 0 0 40px 0 rgba(121, 155, 75, 0.20)' }}
                className='bg-[#11131780] backdrop-blur-sm py-[65px] px-[90px]  rounded-2xl border border-white/10 shadow-2xl relative max-h-[376px] max-w-[896px] flex flex-col items-center justify-cente'
              >
                ...
                <div className='flex flex-col sm:flex-row items-center justify-between pt-[35px] gap-6 sm:gap-10'>
                  <div className='flex items-center gap-6 border-r border-[#21242C] pr-12'>
                    ...
                    <div>
                      ...
                      <p className='text-[16px] text-[#9096A2]'>
                  ...
                  <div className='text-center sm:text-right'>
                    <p className='text-xl font-bold text-[#799B4B]'>
                      {activeTestimonial.metric}
                    </p>
                    {activeTestimonial.improvement && (
                      <p className='text-sm text-center text-[#9096A2]'>
                        {activeTestimonial.improvement}
                      </p>
                    )}
                  </div>
                ...
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <div className='flex flex-col items-center'>
                      ...
                      <p className='text-sm font-bold text-[#799B4B]'>
                        {testimonial.metric}
                      </p>
                    </div>
                  </div>
