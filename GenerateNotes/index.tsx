...
import { TabContent } from '@/app/components/common';
...
export const GenerateNotes: React.FC = (): React.ReactElement => {
    ...
    return (
        <section
            id="generic-notes"
            className="generate-notes bg-bgGray dark:bg-dark-100 relative overflow-hidden "
        >
            <div className="bg-white dark:bg-dark-200 h-full w-full absolute left-1/2 hidden lg:block"></div>
