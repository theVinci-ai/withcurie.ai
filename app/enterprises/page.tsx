    ...
    <div className="min-h-screen bg-[#07090D] text-white overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 mb-8">
                <button className="bg-[#799B4B] text-white px-4 md:px-8 py-3 rounded-lg hover:bg-[#799B4B]/90 transition-colors font-medium flex items-center gap-2 text-sm md:text-base whitespace-nowrap">
                ...
                <button className="text-white border border-gray-600 px-4 md:px-8 py-3 rounded-lg hover:border-gray-400 transition-colors text-sm md:text-base whitespace-nowrap">
                  Calculate $100M+ ROI
                </button>
              </div>
            ...
            <div className="bg-gray-900/80 border border-gray-800 rounded-2xl p-8">
              <div className="mb-6 text-center">
                <h3 className="text-[#799B4B] text-lg font-medium mb-2">
                  Enterprise Impact
                </h3>
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  <div className="text-3xl font-bold text-[#799B4B] mb-1">
                    99.9%
                  </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[#799B4B] font-bold">7,615</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 text-sm">
                    Active AI Agents
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[#799B4B] font-bold">$9,138</span>
                </div>
              </div>
      ...
      <section className="px-4 md:px-6 py-12 md:py-20 bg-black">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-700 rounded-xl p-6 hover:border-[#799B4B]/50 transition-all duration-300 hover:shadow-lg hover:shadow-[#799B4B]/10">
              ...
              <button className="w-full bg-gray-800/50 border border-gray-700 text-white py-3 rounded-lg hover:bg-gray-700/50 transition-colors">
                View Case Study
              </button>
            </div>

            {/* Multi-State Hospital Systems */}
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-[#799B4B]/30 transition-all duration-300">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6">
                <img
      ...
      <section className="px-4 md:px-6 py-12 md:py-20 bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative mb-16 mt-8 md:mt-20 ml-0 md:ml-24">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-4">
              ...
              <div className="space-y-2">
                ...
                <div
                  className="bg-red-900/20 border border-red-800/50 p-4 md:p-6 w-full max-w-sm md:w-[378.66px] md:h-[330px] rounded-xl"
                  style={{
              ...
              <div className="space-y-2">
                ...
                <div
                  className="bg-[#799B4B]/10 border border-[#799B4B]/30 p-4 md:p-6 w-full max-w-sm md:w-[378.66px] md:h-[330px] rounded-xl"
                  style={{
                    border: "1px solid #799B4B",
                  }}
                >
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
          ...
          <div
            className="bg-gray-900/80 border border-gray-800 p-6 md:p-8 mx-auto w-full max-w-2xl md:w-[615.88px] md:h-[134px] rounded-2xl"
            style={{
      ...
      <section className="px-6 py-12 md:py-20 bg-black">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-[#799B4B] rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-6">
              <svg
            ...
            <p className="text-lg md:text-xl text-gray-400">
              See how much Practice AI could save your organization
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    type="number"
                    defaultValue="5"
                    className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-[#799B4B] focus:outline-none"
                  />
                </div>
            ...
            {/* Results */}
            <div className="bg-[#799B4B]/10 border border-[#799B4B]/30 rounded-2xl p-8">
      ...
      <section className="px-4 md:px-6 py-12 md:py-20 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="bg-[#799B4B] text-white hover:bg-[#799B4B]/90 transition-colors text-base md:text-lg font-medium flex items-center justify-center gap-2 mx-auto mb-12 w-full max-w-sm md:w-[303px] h-[44px] px-4 md:px-0 rounded-[10px]">
            Schedule Executive Briefing
            <svg
              className="w-5 h-5"
              fill="none"
