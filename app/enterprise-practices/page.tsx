export default function EnterprisePracticesPage() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-20 md:pt-0 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            <button
              className="bg-[#799B4B] hover:bg-[#799B4B]/90 text-white px-4 py-3.5 rounded-lg font-normal flex items-center gap-2 transition-all duration-300 shadow-[0_0_30px_rgba(121,155,75,0.3)] hover:shadow-[0_0_40px_rgba(121,155,75,0.4)] min-w-[240px] justify-center text-center"
              style={{
                fontSize: "13.23px",
                lineHeight: "20px",
            ...
            <button
              className="text-white border border-gray-600 hover:border-gray-400 px-4 py-3.5 rounded-lg font-normal flex items-center gap-2 transition-all duration-300 backdrop-blur-sm bg-white/5 hover:bg-white/10 min-w-[240px] justify-center text-center"
              style={{
                fontSize: "13.23px",
                lineHeight: "20px",
                fontFamily: "Inter, sans-serif",
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-[#94A3B8] text-lg max-w-3xl mx-auto leading-relaxed">
            ...
            types, delivering measurable outcomes and ROI improvements.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mb-16 items-stretch">
          {/* Skilled Nursing Facilities */}
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group hover:bg-gray-900/70 transition-all duration-300 flex flex-col h-full">
            {/* Background pattern */}
            <div className="absolute top-4 right-4 opacity-10">
              <div className="text-6xl font-bold text-[#627084]">SNF</div>
            </div>
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="relative mb-6">
                ...
                <div
                  className="absolute inset-0 -inset-x-2 -inset-y-2 rounded-2xl opacity-30 pointer-events-none"
                  style={{
                    background:
                ...
                <div className="relative z-10">
                  <div className="mb-6 w-14 h-14 flex items-center justify-center overflow-hidden rounded-xl">
                    <img
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-[#799B4B]/20 text-[#799B4B] text-xs px-3 py-1.5 rounded-full border border-[#799B4B]/30">
                    PDPM Optimizer
                  </span>
                  <span className="bg-gray-800/50 text-[#94A3B8] text-xs px-3 py-1.5 rounded-full border border-gray-700/50">
                    Compliance Monitor
                  </span>
                  <span className="bg-gray-800/50 text-[#94A3B8] text-xs px-3 py-1.5 rounded-full border border-gray-700/50">
                    Quality Reporter
          ...
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group hover:bg-gray-900/70 transition-all duration-300 flex flex-col h-full">
            ...
            {/* Background pattern */}
            <div className="absolute top-4 right-4 opacity-10">
              <div className="text-6xl font-bold text-[#627084]">REHAB</div>
            </div>
          ...
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group hover:bg-gray-900/70 transition-all duration-300 flex flex-col h-full">
            ...
            {/* Background pattern */}
            <div className="absolute top-4 right-4 opacity-10">
              <div className="text-6xl font-bold text-[#627084]">MSP</div>
            </div>
          ...
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group hover:bg-gray-900/70 transition-all duration-300 flex flex-col h-full">
            ...
            {/* Background pattern */}
            <div className="absolute top-4 right-4 opacity-10">
              <div className="text-6xl font-bold text-[#627084]">ASC</div>
            </div>
          ...
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group hover:bg-gray-900/70 transition-all duration-300 flex flex-col h-full">
            {/* Background pattern */}
            <div className="absolute top-4 right-4 opacity-10">
              <div className="text-6xl font-bold text-[#627084]">HHH</div>
            </div>
        ...
        <div className="text-center">
          <button className="bg-[#799B4B] hover:bg-[#799B4B]/90 text-white px-10 py-4 rounded-lg font-medium transition-all duration-300 shadow-[0_0_30px_rgba(121,155,75,0.3)] hover:shadow-[0_0_40px_rgba(121,155,75,0.4)]">
      ...
      <section className="relative -mb-32 px-6 bg-black pb-20">
        <div className="max-w-4xl mx-auto relative z-10">
          <div
            className="bg-gray-200 rounded-2xl p-12 text-center shadow-lg"
          ...
          >
            ...
            <p className="text-gray-700 text-base leading-relaxed max-w-2xl mx-auto">
              Healthcare practices are drowning in administrative work. Doctors
              spend more time on paperwork than with patients. Revenue cycles
              are slow and error-prone. Staff burnout is at an all-time high. We
              built Practice AI to change this reality.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pt-56 pb-20 px-6 bg-gray-100">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-[#799B4B] rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start space-x-2">
                      <div className="w-4 h-4 rounded-full bg-[#799B4B] flex items-center justify-center mt-0.5 flex-shrink-0">
                        <svg
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <div className="text-xs text-gray-500 mb-1">Optimize</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              ...
              <span className="text-[#94A3B8]">vs Traditional Software</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {/* AI Workforce */}
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-8 flex flex-col h-full">
              ...
              <div className="border-t border-gray-700 pt-6">
                <p className="text-sm text-[#94A3B8] mb-4 font-medium">
                  AI Workforce Benefits
                </p>
                <ul className="text-sm text-[#799B4B] space-y-2">
                  <li className="flex items-center gap-2">
                    <svg
                      className="w-3 h-3 text-[#799B4B]"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                      <path
            ...
            <div className="bg-gray-800/30 border border-gray-700 rounded-xl p-8 flex flex-col h-full">
              <div className="flex items-center justify-center mb-1">
                <img
          ...
          <div className="text-center">
            <button className="bg-[#799B4B] hover:bg-[#799B4B]/80 text-white px-8 py-3 rounded-lg transition-colors font-medium flex items-center gap-2 mx-auto">
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <button className="bg-[#799B4B] text-white px-6 py-3 rounded-lg font-medium">
              All Agents (20)
            </button>
            <button className="bg-gray-800 hover:bg-gray-700 text-[#94A3B8] px-6 py-3 rounded-lg font-medium transition-colors">
          ...
          {/* CTA Button */}
          <div className="text-center">
            <button className="bg-[#799B4B] hover:bg-[#6B8A42] text-white px-8 py-4 rounded-xl text-lg font-semibold transition-colors inline-flex items-center gap-2">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              ...
              <br />
              <span className="text-[#4A6F3E]">Across Healthcare</span>
            </h2>
          ...
          <div
            ...
            style={{ backgroundColor: "rgba(162, 192, 67, 0.2)" }}
          >
            {/* Header */}
            <div className="text-center mb-8">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              ...
              <span className="text-[#4A6F3E]">Transformation Stories</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div
              className="bg-gray-900 border border-gray-800 p-4 md:p-6 relative w-full max-w-[424px] mx-auto"
              style={{
                minHeight: "400px",
                height: "auto",
                borderRadius: "12px",
            ...
            >
              ...
              <div className="absolute top-4 right-4">
                <div className="bg-gray-800 text-white text-xs px-3 py-1 rounded-full text-left">
                  <div>Epic</div>
                  <div>Integration</div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-3 mb-3">
                  <div className="text-4xl font-bold text-[#4A6F3E]">24X</div>
            ...
            >
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-3 mb-3">
                  <div className="text-4xl font-bold text-[#4A6F3E]">18X</div>
                  <div className="text-sm text-[#94A3B8]">ROI</div>
                </div>
                <div className="flex items-baseline gap-3">
            ...
            >
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-3 mb-3">
                  <div className="text-4xl font-bold text-[#4A6F3E]">16X</div>
                  <div className="text-sm text-[#94A3B8]">ROI</div>
                </div>
                <div className="flex items-baseline gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[#4A6F3E] text-white px-6 py-3 rounded-lg hover:bg-[#3d5a33] transition-colors flex items-center gap-2">
      ...
      <section className="py-20 px-6 bg-gray-900/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Revenue Partnership */}
            <div
              className="border border-gray-800 p-4 md:p-8 w-full max-w-[424px] mx-auto"
              style={{
                minHeight: "400px",
                height: "auto",
                borderRadius: "12px",
            ...
            >
              ...
              <div className="text-center mb-6">
                <div className="text-2xl md:text-3xl font-bold text-[#4A6F3E] mb-2">
                  Revenue Share
                </div>
              ...
              <button className="w-full bg-[#4A6F3E] text-white py-2 md:py-3 rounded-lg hover:bg-[#3d5a33] transition-colors flex items-center justify-center gap-2 text-sm md:text-base">
                Get Started
                <svg
            ...
            {/* Subscription Model */}
            <div
              className="border border-gray-800 p-8 w-full max-w-[424px] mx-auto"
              style={{
                height: "903px",
                borderRadius: "12px",
                backgroundColor: "#0C0E12B2",
            ...
            >
              ...
              <div className="text-center mb-6">
                <div className="text-3xl font-bold text-[#4A6F3E] mb-2">
                  Monthly SaaS
                </div>
                <p className="text-sm text-[#94A3B8]">
              ...
              <button className="w-full bg-[#4A6F3E] text-white py-3 rounded-lg hover:bg-[#3d5a33] transition-colors flex items-center justify-center gap-2">
                Learn More
                <svg
                  className="w-4 h-4"
                  fill="none"
      ...
      <section className="py-20 px-6 bg-black text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center mb-12">
            ...
            <div>
              <div className="text-3xl font-bold text-[#4A6F3E] mb-2">24/7</div>
              <div className="text-[#94A3B8] text-sm">Support</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#4A6F3E] mb-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="bg-gray-900 border border-white text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors">
      ...
      <section className="py-20 px-6 bg-gray-900/30">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Deploy Your <span className="text-[#4A6F3E]">AI Workforce</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <button className="bg-gradient-to-r from-[#4A6F3E] to-[#6B8E5A] text-white px-8 py-3 rounded-lg hover:from-[#3d5a33] hover:to-[#5a7a4a] transition-all duration-300 font-medium flex items-center gap-2">
              Get Started Today
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <button className="text-white border border-white px-8 py-3 rounded-lg hover:bg-white hover:text-gray-900 transition-all duration-300">
              Schedule Demo
            </button>
          </div>
