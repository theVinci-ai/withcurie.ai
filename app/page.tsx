    ...
    <div className='min-h-screen bg-[#07090D] text-white overflow--hidden'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center'>
            ...
            <div className='flex flex-wrap justify-center items-center gap-8'>
              ...
              <div className='flex items-center space-x-2'>
                <Shield className='w-8 h-8 text-[#4A6F3E]' />
      ...
      <section className='py-20 px-6'>
        <div className='max-w-4xl mx-auto'>
          {/* Header */}
          <div className='text-center mb-16'>
            <p className='text-[#799B4B] text-sm rounded-full px-3 py-1 w-fit mx-auto border border-[#799B4B33] uppercase tracking-wider mb-4'>
